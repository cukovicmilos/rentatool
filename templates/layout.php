...
<head>
    ...
    <?php endif; ?>
    @media(max-width:768px){.mobile-menu-toggle{display:flex;margin-right:calc(-1 * var(--spacing-sm))}.main-nav{display:none;position:absolute;top:var(--header-height);left:0;right:0;background:var(--color-black);padding:0;max-height:calc(100vh - var(--header-height));overflow-y:auto;-webkit-overflow-scrolling:touch}.main-nav.open{display:block}.nav-list{flex-direction:column;gap:0}.nav-link{display:flex;align-items:center;justify-content:center;padding:16px var(--spacing-lg);border-bottom:1px solid rgba(255,255,255,0.1);font-size:18px;min-height:56px;-webkit-tap-highlight-color:transparent}.nav-link:active{background:rgba(255,255,255,0.08)}.nav-list{text-align:center}.nav-list>li{text-align:center}.nav-link-dropdown{display:inline-flex;align-items:center;gap:var(--spacing-sm)}.hide-mobile{display:none}.mobile-nav-categories{display:block}.mobile-nav-categories .mobile-cat-item:last-child{border-bottom:1px solid rgba(255,255,255,0.1)}.mobile-cat-link{justify-content:flex-end;font-size:20px;padding:18px var(--spacing-lg);min-height:60px;font-weight:500;gap:var(--spacing-sm)}.mobile-cat-count{font-weight:400;font-size:15px;color:var(--color-gray-400)}.mobile-subcats{background:rgba(255,255,255,0.04)}.mobile-sub-link{justify-content:flex-end;font-size:16px;padding:14px var(--spacing-lg);padding-right:calc(var(--spacing-lg) + 8px);min-height:48px;color:var(--color-gray-300)}.cart-text{display:none}.content-wrapper{flex-direction:column}.content-wrapper.with-sidebar .sidebar{flex:none;width:100%;order:2;margin-top:var(--spacing-xl)}.tools-grid{grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:var(--spacing-md)}.promo-hero-content{grid-template-columns:1fr;text-align:center}.promo-hero-visual{order:-1}.hero-logo-container{max-width:280px;margin:0 auto}}
    </style>

    <!-- Font Awesome - Inlined to eliminate render-blocking request -->
    <style>
    @font-face{font-family:"Font Awesome 6 Free";font-style:normal;font-weight:900;font-display:swap;src:url(<?= asset('fonts/fontawesome/fa-solid-900.woff2') ?>) format("woff2")}
...
<body class="<?= e($bodyClass) ?>">
    ...
    <a href="tel:+381642039933" class="float-phone" aria-label="Pozovite nas">
        <span class="float-phone-icon"><i class="fas fa-phone"></i></span>
        <span class="float-phone-text">064 203 99 33</span>
    </a>
</body>
</html>
